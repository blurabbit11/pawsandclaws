    ...
    $products = $stmt->get_result(); //[]
       ...
       $category = $_POST['category'];
        ...
        $stmt = $conn->prepare("UPDATE products SET product_name=?, product_description=?, product_price=?,
                                product_special_offer=?, product_gender=?, product_category=?  WHERE product_id=?");
        $stmt->bind_param('ssssssi',$title,$description,$price,$offer,$gender,$category,$product_id);
              ...
              <form id="edit-form"  method="POST" action="edit_product.php">
                ...
                <div class="form-group mt-2">
                    ...
                    <select  class="form-select" required name="category" >
                        <option value="bags">Dogs</option>
                        <option value="shoes">Cats</option>
                        <option value="watches">Puppies</option>
                        <option value="clothes">Kittens</option>
                    </select>
                </div>
                
                  <div class="form-group mt-2">
                      <label>Gender</label>
                      <input type="text" class="form-control" value="<?php  echo $product['product_gender']?>"  id="product-gender" name="gender" placeholder="Gender" required/>
                  </div>
